...
public class ClassMetadataReadingVisitor extends ClassVisitor implements ClassMetadata {
	...
	public void visit(int version, int access, String name, String signature, @Nullable String supername,
		...
		System.out
				.printf("className:%s , \nisInterface:%s,  \nisAnnotation:%s, \nisAbstract:%s, \nisFinal:%s , \ninterfaces: %s\r\n",
						this.className, this.isInterface, this.isAnnotation, this.isAbstract, this.isFinal,
						this.interfaces);
	...
	public void visitOuterClass(String owner, String name, String desc) {
		System.out.printf("visitOuterClass()=>owner:\r\n     %s, name: %s, desc: %s \r\n", owner, name, desc);
		this.enclosingClassName = ClassUtils.convertResourcePathToClassName(owner);
	}

	@Override
	public void visitInnerClass(String name, @Nullable String outerName, String innerName, int access) {
		System.out.printf("visitOuterClass()=>name: %s, outerName: %s, innerName: %s, access: %s\r\n", name, outerName,
				innerName, access);
		if (outerName != null) {
